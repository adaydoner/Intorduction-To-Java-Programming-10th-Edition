	...
	public static void main(String[] args) {
		...
		if (status == 0) {
			...
			if(income <= 16700) {
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (171550 - 137050) * 0.28 + (income - 171550) * 0.33;
			}
			else {
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (171550 - 137050) * 0.28 + (372950 - 171550) * 0.33 + (income - 372950) * 0.35;
			}
		} 
		else if (status == 2) {
			if (income <= 8350) {
